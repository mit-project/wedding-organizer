...
<?php endif ?>
        ...
        <div style="color:#CC9966; font-weight:bold; font-size:30px;" align="left">Events</div><br>
         <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
     <form role="form" class="form-horizontal"  action="" method="post" id="events" name="events" onSubmit="return validateForm()">
                  ...
                  <label>Add details about upcoming events you are hosting!</label>
                  <div>&nbsp;</div><br>
              ...
              <input type="text" name="eventName" class="form-control" value="" required>
                                ...
                                <div class="form-group">
                                   ...
                                   <input type="date" name="startDate"  id="startDate" value="" class="form-control" required>
                                    ...
                                    <div class="col-lg-6">
                                   <input type="text" name="sTime" value=""  class="form-control" required>
                                  </div>
                                </div>
                              ...
                              <input type="date" name="endDate" id="endDate" class="form-control" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                   <input type="text" name="eTime" value=""  class="form-control" required>
                                  </div>
                                </div>
                             ...
                             <input type="submit" class="btn btn-info" value="Create Event" name="submit">
