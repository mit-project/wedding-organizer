...
if(isset($_GET['reply'])){
$id=$_GET['reply'];
$result=$conn->query("SELECT * FROM  sent_reply WHERE id=$id") or die($conn->error);
            ...
            <div class="col-sm-9 mail-w3agile">
                <section class="panel">
                    ...
                    <div class="panel-body">
                     ...
                     <input type="text" tabindex="1" id="to" class="form-control" name="to" value="<?php echo $row['senderMail'];?>">
