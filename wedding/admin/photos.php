...
<!DOCTYPE html>
<head>
<title>Admin Panel | Photos</title>
...
<?php endif ?>
        ...
        <div style="color:#CC9966; font-weight:bold; font-size:30px;" align="left">Photos</div><br>
         <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
     <form role="form" class="form-horizontal"  action="" method="post" id="photos" name="photos" enctype="multipart/form-data" >
                  ...
                  <label>Add at least 8 photos highlighting your products or services to give couples a clear picture of your work. </label>
                  <div>&nbsp;</div><br>
         ...
         <input type="submit"class="btn btn-info" value="Add Photos" name="btnAddphoto">
