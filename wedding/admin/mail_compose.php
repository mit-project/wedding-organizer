...
$sql = "INSERT INTO admin_msg (senderName,senderMail,subject,message,receiverMail) VALUES('Admin','$from','$subject','$message','$to')";
if ($conn->query($sql) === TRUE) {


$sql1 = "INSERT INTO admin_sent (senderMail,senderName,subject,message,receiverMail) VALUES('$from','Admin','$subject','$message','$to')";
...
<!DOCTYPE html>
<head>
<title>Admin Panel  | Mail_compose </title>
                        ...
                        <div class="compose-mail">
                            <form role="form-horizontal" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" tabindex="1" id="from" class="form-control" name="from" required>
                                    </div>
                                

                                <div class="form-group">
                                    <label for="subject" class="">Subject:</label>
                                    <input type="text" tabindex="1" id="subject" class="form-control" name="subject" required>
                                </div>

                                <div class="compose-editor">
                                    <textarea class="wysihtml5 form-control" rows="9" name="message" required></textarea>
                                    <input type="file" class="default">
                                </div>
                                <div class="compose-btn">
                                    <button class="btn btn-primary btn-sm" type="submit" name="send"><i class="fa fa-check"></i> Send</button>
