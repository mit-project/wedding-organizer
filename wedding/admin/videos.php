...
<?php endif ?>
        ...
        <div style="color:#CC9966; font-weight:bold; font-size:30px;" align="left">Videos</div><br>
         <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
     <form role="form" class="form-horizontal"  action="" method="post" id="videos" name="videos" enctype="multipart/form-data" >
                  ...
                  <label>Showcase your work by adding videos to your Storefront. Add unlimited videos related to your business and wedding services. </label>
                  <div>&nbsp;</div><br>
                 ...
                 <input type="text" name="vendor_id" placeholder="" id="vendor_id"  class="form-control" required>
                             ...
                             <input type="submit"class="btn btn-info" value="Add Vidoes" name="addVideo">
