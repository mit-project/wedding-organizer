...
$sql1="SELECT COUNT(id) AS totalsent FROM admin_sent WHERE senderMail='$email'";
$result1=mysqli_query($conn,$sql1);
$values1=mysqli_fetch_assoc($result1);
$num_rows1=$values1['totalsent'];
?>
<!DOCTYPE html>
<head>
            ...
            <div class="col-sm-9 mail-w3agile">
                <section class="panel">
                    <header class="panel-heading wht-bg">
                       <h4 class="gen-case">Sent (<?php echo $num_rows1; ?>)
                         </h4>
                    </header>
                    <div class="panel-body minimal">
                        ...
                        <?php
                        $email = $_SESSION['Email'];
                         $sql = "SELECT * FROM admin_sent WHERE senderMail='$email'";
                         $result = mysqli_query($conn, $sql);
                          //var_dump($result);die;
                          if ($result){
                        ...
                        <tr class="unread">
                            ...
                            <td class="view-message  dont-show"><a href="href="showsentMail.php?read=<?php echo $value['id']; ?>"></a><?php echo $value['receiverMail'];?></td>
