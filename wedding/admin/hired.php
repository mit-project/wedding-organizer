...
<!DOCTYPE html>
<head>
<title>Admin Panel | Hired Vendors</title>
	...
	<section class="wrapper">
		<div class="wthree-font-awesome">
			<div class="grid_3 grid_4 w3_agileits_icons_page">
						<div class="icons">
							<h2 class="w3ls_head">Hired Vendors</h2>
							<section id="new">
								<h3 class="page-header page-header icon-subheading"><?php echo $num_rowsHired; ?>&nbsp;Vendors</h3>							  
      ...
      <table class="table" ui-jq="footable" ui-options='{
        ...
        <tbody>
                                                ...
                                                <?php $sql = "SELECT * FROM hired_vendors";?>
                                               ...
                                               <?php //var_dump($result);die;?>
                                                ...
                                                <tr>
        <td><img src="<?php echo 'uploads/'.$value['image'];?>" class="avatar" border_radius="50%" width="50px" height="50px">
                                                    <td><?php echo $value['businessName']; ?></td>
                                                    <td><?php echo $value['contactPerson']; ?></td>
                                                    <td><?php echo $value['Contactno']; ?></td>
                                                    <td><?php echo $value['vendorMail']; ?></td>
