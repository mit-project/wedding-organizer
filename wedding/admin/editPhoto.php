...
$_SESSION['message'] ="Photo has been updated";
...
<!DOCTYPE html>
<head>
<title>Admin Panel | Edit Photos</title>
...
<?php endif ?>
        ...
        <div class="wthree-font-awesome">
         <div class="row">
                <div class="col-lg-12">
                    <section class="panel">
     <form role="form" class="form-horizontal"  action="" method="post" id="photos" name="photos" enctype="multipart/form-data" >
     <input type="hidden" name="id" value="<?php echo $row['id'];?>" />
                        ...
                        <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                 <input type="text" name="vendor_id" value="<?php echo $row['vendor_id'];?>" id="vendor_id"  class="form-control" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control" required>
                                     <option value="Main Image"<?php if($row['status']=="Main image"){ echo "selected";}?>>Main Image</option>
                                     <option value="Sample"<?php if($row['status']=="Sample"){ echo "selected";}?>>Sample</option>
                                     </select> 
