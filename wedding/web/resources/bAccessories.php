...
<head>
	<title>Bridal Accessories | Wedding organizer</title>
	<!-- Meta-Tags -->
...
<body>
	...
	<div class="banner inner-banner" id="home">
		...
		<!-- //header -->
		<h1 class="inner-title-agileits-w3layouts">Bridal Accessories</h1>
	</div>
	<!-- //banner -->
	<!-- breadcrumb -->
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Bridal Accessories</li>
		</ol>
	</nav>
	<!-- //breadcrumb -->
...
$result=$conn->query("SELECT * FROM  vendor_registration WHERE category='Bridal Accessories'") or die($conn->error);
