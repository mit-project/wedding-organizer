...
<head>
	<title>Favourites | Wedding organizer</title>
	<!-- Meta-Tags -->
...
<body>
	...
	<div class="banner inner-banner" id="home">
		...
		<!-- //header -->
		<h1 class="inner-title-agileits-w3layouts">Favourites</h1>
	</div>
	<!-- //banner -->
	<!-- breadcrumb -->
...
<h5 class="main-w3l-title" style="color:#003366;">Total Favourites (<?php echo $num_rows2;?>)</h5>
<?php

$result=$conn->query("SELECT * FROM  favourite WHERE user_name='$email'") or die($conn->error);
...
<p class="paragraph-agileinfo"><span style="color:#666666; font-weight:bold;">Contact Person:</span>&nbsp;<?php echo $row['contact_person'];?>
</p>
...
<script>
		...
		{
		if(confirm("Do you want to remove this from favourite?")){
		   window.location.href='removeFavourite.php?del_id=' +delid+'';
		   return true;
		}
		}
		</script>
