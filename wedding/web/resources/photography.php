...
<head>
	<title>Photography | Wedding organizer</title>
	<!-- Meta-Tags -->
...
<body>
	...
	<div class="banner inner-banner" id="home">
		...
		<!-- //header -->
		<h1 class="inner-title-agileits-w3layouts">Photography</h1>
	</div>
	<!-- //banner -->
	<!-- breadcrumb -->
...
$result=$conn->query("SELECT * FROM  vendor_registration WHERE category='Photography'") or die($conn->error);
