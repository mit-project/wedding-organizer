...
$sql1="SELECT COUNT(id) AS total FROM favourite WHERE user_name='$email' AND category='Venue'";
$result1=mysqli_query($conn,$sql1);
$values1=mysqli_fetch_assoc($result1);
$num_rows1=$values1['total'];

$sql2="SELECT COUNT(id) AS totalHired FROM hired_vendors WHERE user_name='$email' AND category='Venue'";
$result2=mysqli_query($conn,$sql2);
$values2=mysqli_fetch_assoc($result2);
$num_rows2=$values2['totalHired'];
...
<head>
	<title>Venue | Wedding organizer</title>
	<!-- Meta-Tags -->
...
<body>
	...
	<div class="banner inner-banner" id="home">
		...
		<!-- //header -->
		<h1 class="inner-title-agileits-w3layouts">Venues</h1>
	</div>
	<!-- //banner -->
	<!-- breadcrumb -->
...
$result=$conn->query("SELECT * FROM  vendor_registration WHERE category='Venue'") or die($conn->error);
