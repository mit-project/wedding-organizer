...
<section class="contact py-5">
		<div class="container py-xl-5 py-sm-3">
			...
			<div class="row">
                ...
                <div style="font-size:18px; padding-top:20px;">SENT MAIL (<?php echo $num_rows1;?>)</div>
                <div class="table-inbox-wrap ">
                            <table class="table table-inbox ">
                        <tbody>
                        <?php
                       $email= $_SESSION['email'];
                         $sql = "SELECT * FROM sent_message WHERE senderMail='$email'";
                         $result = mysqli_query($conn, $sql);
                          //var_dump($result);die;
                          if ($result){
                        ...
                        <tr class="unread">
                            ...
                            <td class="inbox-small-cells"><i class="fa fa-star" style="color:#CCCC00;"></i></td>
      <td class="view-message  dont-show"><a href="showSentMail.php?read=<?php echo $value['id'];?>" style="color:#000000;"><?php echo $value['receiverName'];?></a></td>
     <td class="view-message "><a href="showSentMail.php?read=<?php echo $value['id']; ?>" style="color:#000000;"><?php echo $value['subject'];?></a></td>
