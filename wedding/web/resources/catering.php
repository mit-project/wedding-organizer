...
<head>
	<title>Catering | Wedding organizer</title>
	<!-- Meta-Tags -->
...
<body>
	...
	<div class="banner inner-banner" id="home">
		...
		<!-- //header -->
		<h1 class="inner-title-agileits-w3layouts">Catering</h1>
	</div>
	<!-- //banner -->
	<!-- breadcrumb -->
...
$result=$conn->query("SELECT * FROM  vendor_registration WHERE category='Catering'") or die($conn->error);
