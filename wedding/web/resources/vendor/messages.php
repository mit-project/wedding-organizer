...
<body>
    ...
    <label style="font-size:22px;">INBOX (<?php echo $num_rows; ?>)</label>
    <div>&nbsp;</div><br>
     <div class="table-inbox-wrap ">
                        ...
                        <?php
                       $email=$_SESSION['login_user'];
                         $sql = "SELECT * FROM message WHERE vendor_id=$vid";
                         $result = mysqli_query($conn, $sql);
                          //var_dump($result);die;
                          if ($result){
      ...
      <td class="view-message  dont-show"><a href="showMail.php?read=<?php echo $value['id'];?>"><?php echo $value['senderName'];?></a></td>
