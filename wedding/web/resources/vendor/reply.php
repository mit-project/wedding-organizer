...
if(isset($_GET['reply'])){
$id=$_GET['reply'];
$result=$conn->query("SELECT * FROM message WHERE id=$id") or die($conn->error);
...
$receiverName = $row2['senderName'];
$senderName = $row2['receiverName'];
$senderMail = $row2['vendorMail'];
$message = $_POST['msg'];
$vendor_id = $row2['vendor_id'];
$businessName =$row['businessName'];


$sql = "INSERT INTO reply (subject,senderName,senderMail,message,receiverMail,ReceiverName,vendor_id,businessName) VALUES('$subject','$senderName','$senderMail','$message','$receiverMail','$receiverName','$vendor_id','$businessName')";

if($conn->query($sql) === TRUE) {

$sql1 = "INSERT INTO sent_reply (subject,receiverMail,receiverName,message,senderMail,senderName) VALUES('$subject','$receiverMail','$receiverName','$message','$senderMail','$senderName')";
...
<?php endif ?>
    ...
    <label>To:</label>
    <input type="text" name="to" class="form-control" value="<?php echo $row2['email'];?>" >
    </div>
    <div class="form-group">
    <label>Subject</label>
