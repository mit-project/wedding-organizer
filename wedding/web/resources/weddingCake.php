...
<head>
	<title>Wedding cakes | Wedding organizer</title>
	<!-- Meta-Tags -->
...
<body>
	...
	<div class="banner inner-banner" id="home">
		...
		<!-- //header -->
		<h1 class="inner-title-agileits-w3layouts">Wedding Cakes</h1>
	</div>
	<!-- //banner -->
	<!-- breadcrumb -->
	...
	<!-- //breadcrumb -->
<div class="modal fade" id="Hired" tabindex="-1" role="dialog">    

  <div class="modal-dialog modal-full-height modal-right modal-notify modal-info" role="document">
    <div class="modal-content">
      <!--Header-->
      <div class="modal-header" style="background-color:#CC9999;">
        <p class="heading lead" style="color:#FFFFFF;">Hired Vendors
        </p>
...
$result=$conn->query("SELECT * FROM  vendor_registration WHERE category='Wedding cakes'") or die($conn->error);
