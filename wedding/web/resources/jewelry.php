...
<head>
	<title>Jewellary | Wedding organizer</title>
	<!-- Meta-Tags -->
...
<body>
	...
	<div class="banner inner-banner" id="home">
		...
		<!-- //header -->
		<h1 class="inner-title-agileits-w3layouts">Wedding Jewelry</h1>
	</div>
	<!-- //banner -->
	<!-- breadcrumb -->
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Wedding Jewelry</li>
		</ol>
	</nav>
	<!-- //breadcrumb -->
...
$result=$conn->query("SELECT * FROM  vendor_registration WHERE category='Jewellary'") or die($conn->error);
