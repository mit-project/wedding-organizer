...
<section class="contact py-5">
		<div class="container py-xl-5 py-sm-3">
			...
			<div class="row">
                ...
                <div style="font-size:18px; padding-top:20px;">INBOX (<?php echo $num_rows;?>)</div>
                <div class="table-inbox-wrap ">
                            <table class="table table-inbox ">
                        <tbody>
                        <?php
                       $email= $_SESSION['email'];
                         $sql = "SELECT * FROM reply WHERE receiverMail='$email'";
                         $result = mysqli_query($conn, $sql);
                          //var_dump($result);die;
                          if ($result){
      ...
      <td class="view-message  dont-show"><a href="showMail.php?read=<?php echo $value['id'];?>" style="color:#000000;"><?php echo $value['businessName'];?></a></td>
     <td class="view-message "><a href="showMail.php?read=<?php echo $value['id']; ?>" style="color:#000000;"><?php echo $value['subject'];?></a></td>
