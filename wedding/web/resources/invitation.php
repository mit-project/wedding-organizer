...
<head>
	<title>Wedding Invitations | Wedding organizer</title>
	<!-- Meta-Tags -->
...
<body>
	...
	<div class="banner inner-banner" id="home">
		...
		<!-- //header -->
		<h1 class="inner-title-agileits-w3layouts">Wedding Invitations</h1>
	</div>
	<!-- //banner -->
	<!-- breadcrumb -->
	<nav aria-label="breadcrumb">
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Wedding Invitations</li>
		</ol>
	</nav>
	<!-- //breadcrumb -->
...
$result=$conn->query("SELECT * FROM  vendor_registration WHERE category='Wedding invitation'") or die($conn->error);
