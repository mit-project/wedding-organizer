			    ...
			    <form action="#" method="post">
						<div class="form-row">
							<div class="form-group col-md-6">
								<label>To</label>
								<input type="email" class="form-control" placeholder="Receiver Email" name="to">
							</div>
							
							<div class="form-group col-md-6">
								<label for="exampleFormControlInput1">From</label>
								<input type="email" class="form-control" id="exampleFormControlInput1" placeholder="Sender Email" name="from">
							</div>
